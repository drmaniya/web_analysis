...
<!--***************** Switch Button Code End *********************-->
    ...
    <section class="content-header">
      <h1>
        Chat List
        <small>Delete || Update Chat</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Manage Mesaage</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Avilable Message</h3>
            </div>
            <!-- /.box-header -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                	...
                	<tr align="center">	
						...
						<?php }else{ ?>
                        		<i class="fa fa-eye" style="color:#03F"></i>
                        
                        <?php } ?>
                        </td>
                        <td><?php echo @$row['send_time']; ?></td>
                        <td><?php echo @$row['seen_time']; ?></td>
                        <td><a href="<?php echo site_url('admin/Message/delete/'.@$row['message_id']); ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o" aria-hidden="true"></i> </a>&nbsp;||&nbsp;<a href="<?php echo site_url('admin/Message/update/'.$row['message_id']); ?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php }?>
