...
<!--<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a href="<?php echo site_url(); ?>Bank/help" class="nav-link">Help Article</a>
			</li>
        		...
        		<div class="card-body">
        			<form action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
		                ...
		                <div class="form-group">
		                    <label class="control-label">Total Payable Amount(<i class="fa fa-rupee"></i>)</label>
		                ...
		                <div class="form-group">
		                    <label class="control-label"> Package Info</label>
                       ...
                       <?php // echo $failure; ?>
		                <div class="form-group">
		                    ...
		                    <input type="hidden" name="udf1" value="<?php echo $package_id; ?>" size="64" />
		                    <input type="hidden" name="udf2" value="<?php echo $user_id; ?>" size="64" />
