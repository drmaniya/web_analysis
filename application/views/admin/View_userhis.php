...
<!--***************** Switch Button Code End *********************-->
    ...
    <section class="content-header">
      <h1>
        User Login & Logout History List
        <small>Delete History</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Manage History</a></li>
            ...
            <div class="box-body search2">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                	...
                	<?php foreach(@$userlog_data as $row) {?>
                	<tr>	
                        ...
                        <td><a href="<?php echo site_url('admin/History/delete_userhis/'.@$row['log_id']); ?>"><i class="fa fa-trash-o" aria-hidden="true"></i> </a></td>
                    </tr>
                    <?php }?>
                     <tr>
                        <td colspan="6">
